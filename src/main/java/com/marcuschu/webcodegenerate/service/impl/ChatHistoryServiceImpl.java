...
import com.marcuschu.webcodegenerate.mapper.ChatHistoryMapper;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory> implements ChatHistoryService {
    ...
    @Override
    public ChatHistory saveMessage(Long appId, Long userId, String message, ChatHistoryMessageTypeEnum messageType) {
        return saveMessage(appId, userId, message, messageType, null);
    }



    @Override
    public ChatHistory saveMessage(Long appId, Long userId, String message, ChatHistoryMessageTypeEnum messageType, Long parentId) {
